...
if __name__ == '__main__':
    ...
    net.to(device)
    inp_shape = (3, 256, 256)
    flops, params = get_model_complexity_info(net, (3,256,256), verbose=False, print_per_layer_stat=False)
    ...
    res.to(device)
    #torchsummary.summary(res, inp_shape)    
    flops, params = get_model_complexity_info(res, (3,256,256), verbose=False, print_per_layer_stat=False)
    torchsummary.summary(res, inp_shape)   
    print('{:<30}  {:<8}'.format('Computational Complexity: ', flops))
    print('{:<30}  {:<8}'.format('Computational Complexity: ', params))
    ...
    #TransNafNet---------------------------------------------------------------------------------------------------------------------------------------------------------
    custom = HybridNAFNet(enc_blk_nums=[4,2,6],middle_blk_num=12,dec_blk_nums=[4,2,2],refinement=4)
    custom.to(device)
    #Model Summary
    ...
    custom = HybridNAFNet(enc_blk_nums=[2,1,3],middle_blk_num=6,dec_blk_nums=[2,1,1],refinement=2)
    custom.to(device)
    #Model Summary
    torchsummary.summary(custom,inp_shape)
    flops, params = get_model_complexity_info(custom, (3,256,256), verbose=False, print_per_layer_stat=False)
